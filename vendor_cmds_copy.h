...
enum ltq_nl80211_vendor_subcmds {
  ...
  LTQ_NL80211_VENDOR_SUBCMD_GET_RTS_THRESHOLD = 352,

  LTQ_NL80211_VENDOR_SUBCMD_SET_AP_RETRY_LIMIT = 353,
  LTQ_NL80211_VENDOR_SUBCMD_GET_AP_RETRY_LIMIT = 354,

  LTQ_NL80211_VENDOR_SUBCMD_CHANNEL_SWITCH_DEAUTH_CFG = 355,
  LTQ_NL80211_VENDOR_SUBCMD_GET_ERP_CFG = 362,

  LTQ_NL80211_VENDOR_SUBCMD_SET_HE_NON_ADVERTISED = 363,

  LTQ_NL80211_VENDOR_SUBCMD_SET_HE_DEBUG_DATA = 364,

  LTQ_NL80211_VENDOR_SUBCMD_SET_OUT_OF_SCAN_CACHING = 365,
  LTQ_NL80211_VENDOR_SUBCMD_GET_OUT_OF_SCAN_CACHING = 366,

  LTQ_NL80211_VENDOR_SUBCMD_GET_PHY_CHAN_STATUS = 367,
