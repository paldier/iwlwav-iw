 ...
 * @NL80211_BAND_ATTR_HT_TX_BF_CAPA: HT transmit beam forming capabilities
...
enum nl80211_band_attr {
	...
	NL80211_BAND_ATTR_HT_TX_BF_CAPA,
 ...
 * @NL80211_BSS_NOISE: noise level when receiving probe response/beacon frames in dBm (s8).
