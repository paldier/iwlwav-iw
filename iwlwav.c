                                          ...
                                          enum ltq_nl80211_vendor_subcmds subcmd)
{
    ...
    strncpy(data,argv[0], TEXT_ARRAY_SIZE);
	data[TEXT_ARRAY_SIZE - 1] = '\0';
                                          ...
                                          enum ltq_nl80211_vendor_subcmds subcmd)
{
    ...
    memcpy(data8, &sa_family, sizeof(uint16_t));
...
static int handle_iwlwav_set_dtim_period(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_DTIM_PERIOD);
}
COMMAND(iwlwav, sDTIMPeriod, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_dtim_period, "");

static int handle_iwlwav_set_beacon_period(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_BEACON_PERIOD);

}
COMMAND(iwlwav, sBeaconPeriod, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_beacon_period, "");
...
static int handle_iwlwav_set_11d_active(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_11AD_ACTIVE);
}
COMMAND(iwlwav, s11dActive, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_11d_active, "");
...
static int handle_iwlwav_set_sta_keep_alive_in(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_STA_KEEPALIVE_INTERVAL);

}
COMMAND(iwlwav, sStaKeepaliveIN, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_sta_keep_alive_in, "");
...
static int handle_iwlwav_set_basic_rate_set(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_BSS_BASIC_RATE_SET);

}
COMMAND(iwlwav, sBasicRateSet, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_basic_rate_set, "");

static int handle_iwlwav_set_up_rescan_exmp_tm(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_UP_RESCAN_EXEMPTION_TIME);
}
COMMAND(iwlwav, sUpRescanExmpTm, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_up_rescan_exmp_tm, "");
...
static int handle_iwlwav_set_l2_nat_loc_mac(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_addr(state, msg, argc, argv, id, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_HSTDB_LOCAL_MAC);
}
COMMAND(iwlwav, sL2NATLocMAC, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_l2_nat_loc_mac, "");

static int handle_iwlwav_set_irb_png_enabled(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_IRB_PINGER_ENABLED);
}
COMMAND(iwlwav, sIRBPngEnabled, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_irb_png_enabled, "");

static int handle_iwlwav_set_irb_png_stats_rst(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_IRB_PINGER_STATS);
}
COMMAND(iwlwav, sIRBPngStatsRst, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_irb_png_stats_rst, "");
...
static int handle_iwlwav_set_inter_det_time(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 6, 6, LTQ_NL80211_VENDOR_SUBCMD_SET_INTERFER_TIMEOUTS);
}
COMMAND(iwlwav, sInterfDetTime, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_inter_det_time, "");
...
static int handle_iwlwav_set_inter_det_scan(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 2, 2, LTQ_NL80211_VENDOR_SUBCMD_SET_INTERFER_SCANTIMES);
}
COMMAND(iwlwav, sInterfDetScan, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_inter_det_scan, "");
...
static int handle_iwlwav_set_scan_params_bg(struct nl80211_state *state,
                                          ...
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 6, 6, LTQ_NL80211_VENDOR_SUBCMD_SET_SCAN_PARAMS_BG);
}
...
static int handle_iwlwav_set_scan_cal_cw_masks(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 2, 2, LTQ_NL80211_VENDOR_SUBCMD_SET_CALIB_CW_MASKS);
}
COMMAND(iwlwav, sScanCalCwMasks, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_scan_cal_cw_masks, "");
...
static int handle_iwlwav_set_bss_load_in_beacon(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_BSS_LOAD_IN_BEACON);
}
COMMAND(iwlwav, sBssLoadInBeacon, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_bss_load_in_beacon, "");
...
static int handle_iwlwav_set_four_addr_mode(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_4ADDR_MODE);
}
COMMAND(iwlwav, sFourAddrMode, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_four_addr_mode, "");
...
static int handle_iwlwav_set_enable_mrcoex(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_COEX_ENABLE);
}
COMMAND(iwlwav, sEnableMRCoex, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_enable_mrcoex, "");
...
static int handle_iwlwav_set_config_mrcoex(struct nl80211_state *state,
                                          ...
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_COEX_CFG);
}
...
static int print_he_operation_bss_color(struct nl_msg *msg, void *arg)
{
  ...
  printf("%d ", (data[7] & HE_OPERATION_BSS_COLOR));
    ...
    char **argv, enum id_input id, uint16_t sub_cmd, uint8_t num_of_params, char* print_msg)
{
  ...
  if ( strlen(print_msg) >= sizeof(print_d.print_msg))
  {
    strncpy(print_d.print_msg, print_msg, (sizeof(print_d.print_msg) - 1));
    print_d.print_msg[sizeof(print_d.print_msg) - 1] = '\0';
  } else {
    strncpy(print_d.print_msg, print_msg, strlen(print_msg));
  }
...
static int print_he_operation_bss_color_disabled_flag(struct nl_msg *msg, void *arg)
{
  ...
  data = (uint8_t *) nla_data(attr);
  printf("%s:", print_d->print_msg);
  printf("%d ", ((data[7] & HE_OPERATION_BSS_COLOR_DISABLED)? 1:0 ));
...
static int print_vendor_int(struct nl_msg *msg, void *arg)
{
	...
	if (!print_d->num_of_params)
		print_d->num_of_params = (nla_len(attr) - NL_ATTR_HEADER_LEN) / sizeof(int);

	data = (uint8_t *) nla_data(attr);
	printf("%s:", print_d->print_msg);
	for(i = 0; i < print_d->num_of_params ; i++)
		printf("%d ", get_uint32_value(data,i+1));
...
static int print_vendor_addr(struct nl_msg *msg, void *arg)
{
	...
	printf("%s:", print_d->print_msg);
	printf("%.2x:%.2x:%.2x:%.2x:%.2x:%.2x", data[4], data[5], data[6], data[7], data[8], data[9]);
	printf("\n");
...
static int handle_iwlwav_get_dtim_period(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_DTIM_PERIOD, 1, "gDTIMPeriod");
}
COMMAND(iwlwav, gDTIMPeriod, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_dtim_period, "");

static int handle_iwlwav_get_beacon_period(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_BEACON_PERIOD, 1, "gBeaconPeriod");
}
COMMAND(iwlwav, gBeaconPeriod, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_beacon_period, "");
...
static int handle_iwlwav_get_11d_active(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_11AD_ACTIVE, 1, "g11dActive");
}
COMMAND(iwlwav, g11dActive, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_11d_active, "");
...
static int handle_iwlwav_get_sta_keepalive_interval(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_STA_KEEPALIVE_INTERVAL, 1, "gStaKeepaliveIN");
}
COMMAND(iwlwav, gStaKeepaliveIN, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_sta_keepalive_interval, "");
...
static int handle_iwlwav_get_network_mode(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_NETWORK_MODE, 1, "gNetworkMode");
}
COMMAND(iwlwav, gNetworkMode, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_network_mode, "");
...
static int handle_iwlwav_get_basic_rate_set(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_BSS_BASIC_RATE_SET, 1, "gBasicRateSet");
}
COMMAND(iwlwav, gBasicRateSet, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_basic_rate_set, "");

static int handle_iwlwav_get_up_rescan_exmp_tm(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_UP_RESCAN_EXEMPTION_TIME, 1, "gUpRescanExmpTm");
}
COMMAND(iwlwav, gUpRescanExmpTm, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_up_rescan_exmp_tm, "");
...
static int handle_iwlwav_get_ls_nat_loc_mac(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_addr_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_HSTDB_LOCAL_MAC, 1, "gL2NATLocMAC");
}
COMMAND(iwlwav, gL2NATLocMAC, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_ls_nat_loc_mac, "");
...
static int handle_iwlwav_get_irb_png_enabled(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_IRB_PINGER_ENABLED, 1, "gIRBPngEnabled");
}
COMMAND(iwlwav, gIRBPngEnabled, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_irb_png_enabled, "");

static int handle_iwlwav_get_irb_png_stats(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_text_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_IRB_PINGER_STATS, 1, "gIRBPngStats");
}
COMMAND(iwlwav, gIRBPngStats, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_irb_png_stats, "");
...
static int handle_iwlwav_get_scan_params_bg(struct nl80211_state *state,
			      ...
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_SCAN_PARAMS_BG, 6, "gScanParamsBG");
}
...
static int handle_iwlwav_get_scan_cal_cw_masks(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_CALIB_CW_MASKS, 2, "gScanCalCwMasks");
}
COMMAND(iwlwav, gScanCalCwMasks, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_scan_cal_cw_masks, "");
...
static int handle_iwlwav_get_bss_load_in_beacon(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_BSS_LOAD_IN_BEACON, 1, "gBssLoadInBeacon");
}
COMMAND(iwlwav, gBssLoadInBeacon, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_bss_load_in_beacon, "");
...
static int handle_iwlwav_get_four_addr_mode(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_4ADDR_MODE, 1, "gFourAddrMode");
}
COMMAND(iwlwav, gFourAddrMode, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_four_addr_mode, "");
...
static int handle_iwlwav_get_enable_mrcoex(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_COEX_ENABLE, 1, "gEnableMRCoex");
}
COMMAND(iwlwav, gEnableMRCoex, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_enable_mrcoex, "");
...
static int handle_iwlwav_help(struct nl80211_state *state,
			      ...
			      char **argv, enum id_input id)
{
	printf("\tdev <devname> iwlwav sDTIMPeriod <DTIM period>\n");
	printf("\t\tSet DTIM period.\n\n");

	printf("\tdev <devname> iwlwav sBeaconPeriod <beacon period>\n");
	printf("\t\tSet beacon period.\n\n");
	...
	printf("\tdev <devname> iwlwav s11dActive <active>\n");
	printf("\t\tSet 11d active.\n\n");
	...
	printf("\tdev <devname> iwlwav sStaKeepaliveIN <keep alive interval>\n");
	printf("\t\tSet STA keep alive interval.\n\n");
	...
	printf("\tdev <devname> iwlwav sBasicRateSet <rate set>\n");
	printf("\t\tSet basic rate set.\n\n");

	printf("\tdev <devname> iwlwav sUpRescanExmpTm <exemption time>\n");
	printf("\t\tSet up rescan exemption time.\n\n");
	...
	printf("\tdev <devname> iwlwav sL2NATLocMAC <mac address>\n");
	printf("\t\tSet ls nat loc mac.\n\n");

	printf("\tdev <devname> iwlwav sIRBPngEnabled <enabled>\n");
	printf("\t\tSet irb png enabled.\n\n");

	printf("\tdev <devname> iwlwav sIRBPngStatsRst <reset>\n");
	printf("\t\tSet irb png stats reset.\n\n");
	...
	printf("\tdev <devname> iwlwav sInterfDetTime <short_scan_polling_timeout> <long_scan_polling_timeout> <active_notification_timeout> <short_scan_notification_timeout> <long_scan_notification_timeout> <value_6>\n");
	printf("\t\tSet interfer timeouts.\n\n");
	...
	printf("\tdev <devname> iwlwav sInterfDetScan <short_scan_max_time> <long_scan_max_time>\n");
	printf("\t\tSet interfer scan times.\n\n");
	...
	printf("\tdev <devname> iwlwav sScanCalCwMasks <calib_cw_masks_2_4> <calib_cw_masks_5>\n");
	printf("\t\tSet scan calib cw masks.\n\n");
	...
	printf("\tdev <devname> iwlwav sBssLoadInBeacon <load in beacon>\n");
	printf("\t\tSet bss load in beacon.\n\n");
	...
	printf("\tdev <devname> iwlwav sEnableMRCoex <enable coex>\n");
	printf("\t\tSet coex enable.\n\n");

	printf("\tdev <devname> iwlwav sConfigMRCoex <coex config>\n");
	printf("\t\tSet coex config.\n\n");
	...
	printf("\tdev <devname> iwlwav g11dActive\n\n");
	printf("\tdev <devname> iwlwav gMACWdTimeoutMs\n\n");
	printf("\tdev <devname> iwlwav gMACWdPeriodMs\n\n");
	printf("\tdev <devname> iwlwav gStaKeepaliveIN\n\n");
	printf("\tdev <devname> iwlwav gBridgeMode\n\n");
	printf("\tdev <devname> iwlwav gReliableMcast\n\n");
	printf("\tdev <devname> iwlwav gAPforwarding\n\n");
	printf("\tdev <devname> iwlwav gNetworkMode\n\n");
	printf("\tdev <devname> iwlwav gCdbCfg\n\n");
	printf("\tdev <devname> iwlwav gBasicRateSet\n\n");
	printf("\tdev <devname> iwlwav gUpRescanExmpTm\n\n");
	printf("\tdev <devname> iwlwav gWDSHostTO\n\n");
	printf("\tdev <devname> iwlwav gL2NATLocMAC\n\n");
	printf("\tdev <devname> iwlwav gEEPROM\n\n");
	printf("\tdev <devname> iwlwav gIRBPngEnabled\n\n");
	printf("\tdev <devname> iwlwav gIRBPngStats\n\n");
	...
	printf("\tdev <devname> iwlwav gScanCalCwMasks\n\n");
	...
	printf("\tdev <devname> iwlwav gBssLoadInBeacon\n\n");
	...
	printf("\tdev <devname> iwlwav gEnableMRCoex\n\n");
